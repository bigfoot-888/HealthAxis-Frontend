...
import { DiagnosisClinicalStatusChip, DiagnosisStatusChip, DiagnosisSeverityChip } from '@diagnoses/components/ui/DiagnosisChips';
...
export default function PatientDiagnosesTable({ diagnoses }) {
        ...
        <>
            {updateDiagnosisClinicalStatusRow && (
                <UpdateDiagnosisClinicalStatusForm
                    ...
                    handleClose={() => setUpdateDiagnosisClinicalStatusow(null)}
                />
            )}
