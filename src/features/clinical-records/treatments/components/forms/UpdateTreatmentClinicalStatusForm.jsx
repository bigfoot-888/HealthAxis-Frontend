...
import { updateTreatmentClinicalStatus } from '@treatments/api/treatment.api';
...
export default function UpdateTreatmentClinicalStatusForm({ treatment, handleClose }) {
    ...
    const statusOptions = Object.entries(TREATMENT_CLINICAL_STATUS_CONFIG).map(([value, { label }]) => ({ value, label }));
