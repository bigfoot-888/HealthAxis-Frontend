...
export default function CreateDiagnosisTreatmentForm({ open, handleClose, diagnosis }) {
    const {
        handleSubmit,
        register,
        control,
    ...
    const onSubmit = async (data) => {
        try {
            ...
            invalidateCreateTreatmentWithAppointment(queryClient, diagnosis, diagnosis.patient)
            handleClose();
