...
import { invalidateCreateTreatmentWithAppointment } from '@treatments/utils/treatment-query.utils';

export default function CreateAppointmentTreatmentForm({ open, handleClose, appointment }) {
    const {
        handleSubmit,
        register,
        control,
    ...
    const onSubmit = async (data) => {
        try {
            ...
            invalidateCreateTreatmentWithAppointment(queryClient, appointment, data.diagnosis)
            handleClose();
